 ...
 * 文件操作处理
 */
public class FileLocalModel extends AbsFileInteraction {

    private static final String TAG = FileLocalModel.class.getSimpleName();

    public FileLocalModel(Context mContext, AbsFileInteraction.DataChangeListener changeListener) {
        super(mContext, changeListener);
    }

    /**
     *
     * @param path can't be null!!
     */
