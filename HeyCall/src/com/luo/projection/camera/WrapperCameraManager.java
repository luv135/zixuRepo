...
/**
 * Created by Luo on 2015/5/21.
 * zxing CameraManager 包装
 */
...
//    }
    ...
    private void openCamera(int face, SurfaceHolder holder) throws IOException {
        ...
        if (theCamera == null) {
            ...
            setCameraDisplayOrientation(context, requestedCameraId, theCamera);
            camera = theCamera;
        }
        theCamera.setPreviewDisplay(holder);
        if (!initialized) {
...
//            isFrontCamera = cameraInfo.facing == Camera.CameraInfo.CAMERA_FACING_FRONT;
     ...
     * @param camera
     */
    private void setCameraDisplayOrientation(Context context,
...
//        isPortrait = (degrees == 0) || (degrees == 180);
        ...
        Log.d(TAG, "是否竖屏: " + isPortrait + "是否前置摄像头: " + isFrontCamera + "旋转角度:" + degrees + "相机角度" + info.orientation + " 处理后角度:" + result);
